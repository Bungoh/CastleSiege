package com.dominion.castlesiege.text;

import com.dominion.castlesiege.CastleSiege;
...
public interface Message {
     ...
     *
     * @return a new MessageSender
     * @see com.dominion.castlesiege.CastleSiege.MainConfig#getPrefix()
     */
    default MessageSender prefixed() {
        return new MessageSender(() -> TextColors.translate(CastleSiege.MainConfig.getPrefix() + "&r " + Message.this.toString()));
    }
    ...
    static MessageSender prefixedText(String text) {
        return new MessageSender(() -> TextColors.translate(CastleSiege.MainConfig.getPrefix() + "&r " + text));
    }
